...
for y in year_list:
    with open('co2-ppm-daily.csv') as co2:
        ...
        print('Annual average of atmospheric CO2 for year', y, ': ', round(annual_avg, 2))
...
with open('co2-ppm-daily.csv') as co2:
    ...
    print('Seasonal average of atmospheric CO2 for Spring (March, April, May): ', round(spring_avg, 2))
    print('Seasonal average of atmospheric CO2 for Summer (June, July, August): ', round(summer_avg, 2))
    print('Seasonal average of atmospheric CO2 for Autumn (September, October, November): ', round(autumn_avg, 2))
    print('Seasonal average of atmospheric CO2 for Winter (December, January, February): ', round(winter_avg, 2))
...
with open('co2-ppm-daily.csv') as co2:
    ...
    for row in csv.reader(co2):
        ...
        print('Anomaly of atmospheric CO2 for', row[0], 'is', round(anomaly, 2), 'relative to total average')

# note: If the answer for no.1, 2, and 3 does not show, please comment on the print part for no.4 (line 95).